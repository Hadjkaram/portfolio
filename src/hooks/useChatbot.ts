...
const knowledgeBase = [
  ...
  },
  {
    ...
    response: "Réalisations stratégiques phares du portfolio (10 architectures déployées en production) :\n\n• Kanyeh Assist : Télé-diagnostic anatomopathologique reliant les CHU de Bouaké, Treichville, le PNLC et le Laboratoire Roche. Modèles YOLOv8/v11 pour atypies cellulaires, visionneuse WSI (tuilage TIFF) et PostgreSQL RLS.\n• Nuria : 1ère plateforme africaine de neurodéveloppement pédiatrique validée par l'UNICEF et le MSHP (Node.js, Next.js, PostgreSQL, Docker, AWS).\n• Tila : Plateforme & app mobile de santé mentale d'envergure internationale, activement mobilisée par l'UNICEF, le PNUD, l'AFD, Expertise France, le PNLT, l'OMS et le PNSM (ci.tila.app, React Native, WebSockets, chiffrement AES-256).\n• XH Skills Academy : Plateforme d'apprentissage en ligne en santé numérique pour l'Afrique (xhskillsacademy.com), portée notamment par Corine Maurice Ouattara. Ibrahim y est Formateur en santé numérique & Tech Lead."
  },
  {
